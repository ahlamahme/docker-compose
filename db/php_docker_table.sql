...
--
-- Host: db:3306
-- Generation Time: Nov 15, 2023 at 08:04 AM
...
INSERT INTO `php_docker_table` (`id`, `tilte`, `body`, `date_created`) VALUES
(1, 'first post', 'first post message', '2023-11-08'),
(2, 'second post', 'second post message', '2023-11-09');
